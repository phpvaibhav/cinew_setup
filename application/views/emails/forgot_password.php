...
<head>
    ...
    <title>AGRINVESTONLINE | Password Reset</title>
        ...
        <tr>
            <td style="text-align: center; background: #fff;">
                <table width="100%" border="0" cellpadding="30" cellspacing="0">    
                    <tr>
                        <td>
                            <img style="max-width: 125px; width: 100%;padding: 10px;"  src="<?php echo base_url().ADMIN_THEME; ?>images/logo/icon_200.png" >
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">Thanks,<br> LIVEWIRE TEAM</p>  
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="text-align: center;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td style="padding: 10px;background: #23c466;color: #fff;">Copyright &copy; <?php echo date('Y') ?>LIVEWIRE</td>
                    </tr>
                </table>
            </td>
        </tr>
